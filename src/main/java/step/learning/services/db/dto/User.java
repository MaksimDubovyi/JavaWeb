...
public class User {
    ...
    public User(String firstName, String lastName, String email,  String phone, Date birthdate, String avatar, String login, String salt, String passwordDk, Date registerDT,String culture, String gender) {
